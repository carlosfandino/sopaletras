...
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"sopaletras_resources/media/i1_arquitecto.jpg");
...
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"sopaletras_resources/media/i2_astronauta.jpg");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;});
$("#idDiv2").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"sopaletras_resources/media/i3_bailarin.jpg");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;});
$("#idDiv3").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"sopaletras_resources/media/i4_bombero.jpg");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;});
$("#idDiv4").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"sopaletras_resources/media/i5_carnicero.jpg");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;});
$("#idDiv5").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"sopaletras_resources/media/i6_cocinero.jpg");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;});
$("#idDiv6").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"sopaletras_resources/media/i7_doctor.jpg");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;});
$("#idDiv7").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"sopaletras_resources/media/i8_panadero.jpg");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;});
$("#idDiv8").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"sopaletras_resources/media/i9_pintora.jpg");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;});
$("#idDiv9").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"sopaletras_resources/media/i10_secretaria.jpg");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;});
}
function paintImaDivs(x,y,imageSrc){
while(y+250>$("#ardoraActSel").height()){y=y-1};while(x+250>$("#ardoraActSel").width()){x=x-1};
